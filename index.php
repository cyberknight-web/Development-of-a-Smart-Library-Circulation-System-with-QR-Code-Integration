...
<head>
    ...
    <style>
        ...
        body { min-height: 100vh; display: flex; align-items: center; justify-content: center; background: radial-gradient(circle at top, #ffe8c2 0, #f5f5f5 50%); font-family: system-ui, -apple-system, sans-serif; }
        .portal-card { max-width: 320px; border-radius: 16px; border: none; box-shadow: 0 12px 40px rgba(0,0,0,0.12); overflow: hidden; text-decoration: none; color: inherit; display: block; transition: transform 0.2s; }
        .portal-card:hover { transform: translateY(-4px); color: inherit; }
        .portal-card .card-body { padding: 1.5rem; }
        .btn-sl { background-color: var(--sl-primary); color: var(--sl-light); border: none; }
        .btn-sl:hover { background-color: #5c0000; color: var(--sl-light); }
    </style>
</head>
<body>
