...
<head>
    ...
    <style>
        ...
        .login-header { background: linear-gradient(135deg, #720000, #4a0000) !important; color: var(--sl-light); padding: 1.5rem 1.75rem; }
        .login-header h1 { font-size: 1.5rem; margin: 0; }
        .login-header p { margin: 0.25rem 0 0; opacity: 0.85; }
        .login-logo { width: 56px; height: 56px; object-fit: contain; background: #fff; border-radius: 50%; padding: 3px; }
