                                    ...
                                    <div class="sl-book-availability-list">
                                        <?php foreach ($availability_books as $book_info): ?>
                                            ...
                                            <div class="sl-book-availability-item">
                                                <div><?php echo htmlspecialchars($book_info['title'] ?? '', ENT_QUOTES, 'UTF-8'); ?></div>
                                                <div class="sl-book-availability-meta">Available Copies: <?php echo $available_copies; ?></div>
                                                <div class="sl-book-availability-meta">Status: <?php echo htmlspecialchars($availability_status, ENT_QUOTES, 'UTF-8'); ?></div>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                <?php else: ?>
