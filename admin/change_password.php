...
admin_render_header('Change Password');
?>
    ...
    <div class="col-12 col-md-8 col-lg-5">
        <div class="card sl-card">
            ...
            <div class="card-body">
                ...
                <form method="post" action="<?php echo BASE_URL; ?>/admin/change_password_action.php" id="adminChangePasswordForm">
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="<?php echo BASE_URL; ?>/admin/dashboard.php" class="btn btn-outline-secondary">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="updatePasswordConfirmModal" tabindex="-1" aria-labelledby="updatePasswordConfirmModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="updatePasswordConfirmModalLabel">Confirm Password Update</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-sl-primary" id="confirmUpdatePassword">Yes</button>
            </div>
        </div>
    </div>
</div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    var confirmButton = document.getElementById('confirmUpdatePassword');
    var confirmModalEl = document.getElementById('updatePasswordConfirmModal');
